...
log_file2="/Volumes/NGS_2/wastewater_sequencing/$run_name/logs/viralrecon.log"

bash run_viralrecon.sh $run_name | tee -a $log_file2
```
...
bash run_viralrecon.sh $run_name -resume | tee -a $log_file2
```
...
```bash
log_file3="/Volumes/NGS_2/wastewater_sequencing/$run_name/logs/freyja.log"

bash run_freyja.sh $run_name | tee -a $log_file3
```
