...
mkdir -p /Volumes/NGS_2/wastewater_sequencing/$run_name/analysis/freyja/lineage_out
...
scov2=$script_dir/data/MN908947.3.fasta

# Define the path to the status file, used to track how many samples have been processed.
status_file="/Volumes/NGS_2/wastewater_sequencing/$run_name/logs/freyja_demix_status.txt"
